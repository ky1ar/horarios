$(document).ready(function () {
  ...
  function calcularSumaCalcPorSemana(userId, year, month) {
    ...
    $(".hrr-box").each(function (index) {
      ...
      // Realiza la solicitud para obtener acumulado_valor_dia e idProfile
      getWeeklyData(
        userId,
        semana,
        year,
        ...
        function (acumuladoValorDia, idProfile) {
          ...
          // Ajustar minutos y horas para mantener la lógica correcta
          if (sumaMinutos >= 60) {
            sumaHoras += Math.floor(sumaMinutos / 60);
            sumaMinutos = sumaMinutos % 60;
          } else if (sumaMinutos <= -60) {
          ...
          $hrrBox
            .find(".minS")
            .text(nuevaHoraResta + "h" + " / " + acumuladoValorDia + "h");
          $hrrBox.find(".porT").text(porcentajeResta.toFixed(1) + "%");
          ...
          $hrrBox
            .find(".minS")
            .text(nuevaHoraSuma + "h" + " / " + acumuladoValorDia + "h");
          $hrrBox.find(".porT").text(porcentajeSuma.toFixed(1) + "%");
        }
      );
    });
  }
