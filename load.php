    ...
    <section id="ky1-rgt">
        ...
        <ul class="ky1-rsm">
            <li>
                ...
                <div class="box-txt">
                    <span id="totalHours" data-id="">42:30 h</span>
                    <p>Total Horas</p>
                </div>
            </li>
            <li>
                ...
                <div class="box-txt">
                    <span id="totalMissingPoints" data-id="">4</span>
                    <p>Sin Registro</p>
                </div>
            </li>
            <li>
                ...
                <div class="box-txt">
                    <span id="totalLatePoints" data-id="">0</span>
                    <p>Tardanzas</p>
                </div>
            </li>
            <li>
                ...
                <div class="box-txt">
                    <span id="totalUnjustifiedAbsences" data-id="">1</span>
