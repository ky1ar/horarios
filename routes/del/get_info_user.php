...
if (isset($_POST['userId']) && isset($_POST['month']) && isset($_POST['year'])) {
    ...
    $stmt->bind_param("isssssiissssiissssiiss", $year, $month, $year, $month, $userId, $year, $month, $year, $month, $currentDate, $userId, $year, $month, $year, $month, $currentDate, $userId, $userId);
    $stmt->execute();
