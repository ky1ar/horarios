...
if (isset($_POST['userId']) && isset($_POST['month']) && isset($_POST['year'])) {
    ...
    $query = "SELECT
        ...
        SUM(
            ROUND(
                ...
                SUM(
                    CASE
                        WHEN c.calendar_date BETWEEN DATE(CONCAT(?, '-', ?, '-01')) AND ? THEN s.calc_diff ELSE 0 END), 0
    ...
    $stmt->bind_param("siissss", $year, $month, $penultimateDayOfMonth, $userId, $userId, $year, $month, $penultimateDayOfMonth);
    $stmt->execute();
